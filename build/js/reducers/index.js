...
var initialState = {
    ...
    languageRating: 0,
    sensualityRating: 0,
    randomValueLow: Math.floor(Math.random() * 25) + 1,
    randomValueMed: Math.floor(Math.random() * 26) + 25,
    randomValueHigh: Math.floor(Math.random() * 26) + 50,
    randomValueOmg: Math.floor(Math.random() * 26) + 75,
    seeRating: false,
    resultQuote: null,
    movie: null,
    result: null,
